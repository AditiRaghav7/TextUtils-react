    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} `}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                {<a className="nav-link active" aria-current="page" href="#">Home</a>}</li>
                 <li>{<a className="nav-link" href="#">{props.aboutText}</a>}
            ...
            <input className="form-check-input" onClick={props.togglemodep} type="checkbox" role="switch" id="switchCheckDefault"/>
